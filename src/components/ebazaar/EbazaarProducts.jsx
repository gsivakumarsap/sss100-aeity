    ...
    <div className="font-sans text-gray-800 bg-white">
      ...
      <header className="bg-white shadow-lg fixed top-0 left-0 right-0 z-50">
        <div className="max-w-6xl mx-auto flex items-center justify-between px-5 py-4 flex-wrap">
          <a href="#" className="text-2xl mr-4 font-bold text-orange-500">AEITY eBazaar</a>
          
          {/* Desktop Navigation */}
          <nav className="hidden md:flex">
            <ul className="flex space-x-8">
              <li><button onClick={() => scrollToSection('categories')} className="text-gray-800 font-medium hover:text-orange-500 transition-colors">Categories</button></li>
              <li><button onClick={() => scrollToSection('vendors')} className="text-gray-800 font-medium hover:text-orange-500 transition-colors">Vendors</button></li>
              <li><button onClick={() => scrollToSection('about')} className="text-gray-800 font-medium hover:text-orange-500 transition-colors">About Us</button></li>
              <li><button className="text-gray-800 font-medium hover:text-orange-500 transition-colors">Support</button></li>
            </ul>
          </nav>
          ...
          {/* Mobile Navigation */}
          {mobileMenuOpen && (
            <nav className="w-full md:hidden mt-4 order-4">
